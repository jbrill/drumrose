...
export function errorMessage (error) {
  ...
  let errors = {
    ...
    [mkError.ACCESS_DENIED]: {
      ...
      icon: 'fa-exclamation-triangle',
      title: 'Access Denied',
      message: `You do not have the necessary permissions to access 
        this content. If this error continues, try signing out and 
        signing back in.`,
    },
    [mkError.AUTHORIZATION_ERROR]: {
      ...
      message: `We were unable to authorize your request.
        If this error continues, try signing out and signing back in.`,
    },
    [mkError.CONFIGURATION_ERROR]: {
      variant: 'danger',
      icon: 'fa-exclamation-triangle',
      title: 'Configuration Error',
      message: `A configuration error is currently preventing 
        this content from loading. Please try again at a later time.`,
    },
    [mkError.CONTENT_RESTRICTED]: {
      variant: 'danger',
      icon: 'fa-exclamation-triangle',
      title: 'Content Restricted',
      message: `You are unable to access this content due 
        to content restritions.`,
    },
    ...
    [mkError.MEDIA_CERTIFICATE]: {
      ...
      message: `We were unable to apply the media certificate.
        Music playback may be unavailable.`,
    },
    ...
    [mkError.MEDIA_KEY]: {
      ...
      message: `We were unable to generate a media key.
        Music playback may be unavailable.`,
    },
    [mkError.MEDIA_LICENSE]: {
      ...
      message: `An error occurred with the media license.
        Music playback may be unavailable.`,
    },
    ...
    [mkError.MEDIA_SESSION]: {
      ...
      message: `We were unable to create the Encrypted 
        Media Extensions (EME) session. Music playback may be unavailable.`,
    },
    [mkError.NETWORK_ERROR]: {
      variant: 'danger',
      icon: 'fa-exclamation-triangle',
      title: 'Network Error',
      message: `We were unable to complete 
        your request due to a network error.`,
    },
    [mkError.NOT_FOUND]: {
      variant: 'warning',
      icon: 'fa-search',
    ...
    [mkError.QUOTA_EXCEEDED]: {
      ...
      message: `This application has exceeded it's 
        Apple Music API quota. Please try again later.`,
    },
    ...
    [mkError.SERVICE_UNAVAILABLE]: {
      ...
      message: `The Apple Music service is 
    ...
    [mkError.REQUEST_ERROR]: {
      ...
      message: `An error occurred while 
        requesting information from Apple Music.`,
    },
  };
