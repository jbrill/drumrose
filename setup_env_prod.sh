...
echo POSTGRES_DB_NAME=$PROD_POSTGRES_DB_NAME >> .django.env
echo POSTGRES_USER=$PROD_POSTGRES_USER >> .django.env
echo POSTGRES_PASSWORD=$PROD_POSTRGES_PASSWORD >> .django.env
echo POSTGRES_HOST=$PROD_POSTGRES_HOST >> .django.env
echo POSTGRES_PORT=$PROD_POSTGRES_PORT >> .django.env
